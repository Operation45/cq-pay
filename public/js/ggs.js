...
var sixteenColBreakpoint = ((1120-1) / baseFontSize)+'em';
...
/*  Create CSS */
    var styles = '\
        ...
        .ggs-15{left:93.75%;}\
        .ggs-16{right:0;}\
        .ggs-0,.ggs-16{width:0;padding-right:0.75em;border:0;margin:0;-moz-box-size:content-box;-webkit-box-sizing:content-box;box-sizing:content-box;}\
        ...
        #ggs-baseline-container {opacity: '+guideOpacity+'; position: absolute; left:0; top:0; z-index: 8000; width: 100%; max-width: 56em; height: 100%; -webkit-transition: opacity 0.235s ease-out; -moz-transition: opacity 0.235s ease-out; -ms-transition: opacity 0.235s ease-out; transition: opacity 0.235s ease-out; overflow-y: hidden;}\
...
/*  Create guides */
  ender('body').append(ender('<div id="ggs-guides"></div>'));

  for (i=0; i<=16; i++) {
    ender('#ggs-guides').append(ender('<div class="ggs-guide ggs-'+i+'"><div></div></div>'));
  };
